...
namespace Panda
{
    ...
    public partial class WEWEEntities : DbContext
    {
        private static WEWEEntities _context;

        public WEWEEntities()
            : base("name=WEWEEntities")
        {
        }

        public static WEWEEntities GetContext()
        {
            if (_context == null)
                _context = new WEWEEntities();
                return _context;
